...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_ReadSim'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_ReadSim.kb_ReadSimImpl import kb_ReadSim  # noqa @IgnorePep8
impl_kb_ReadSim = kb_ReadSim(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_ReadSim'
        ...
        self.rpc_service.add(impl_kb_ReadSim.run_kb_ReadSim,
